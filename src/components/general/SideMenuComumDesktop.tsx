...
import styles from './styles/SideMenuComumDesktop.module.css';
import Link from 'next/link';
import { usePathname } from 'next/navigation';
import { useAuth } from '@/contexts/AuthContext';
import { queryApi } from '@/lib/utils';

interface SideMenuComumDesktopProps {
    set: (isCollapsed: boolean) => void;
}

export function SideMenuComumDesktop({ set }: SideMenuComumDesktopProps) {
